...
cmp qword ptr[rsp], 46C4660h ; check if it's last argument (our fake argument)
jz end_args_calc ; we found our fake argument
 
mov rax, r8; ; new possible function address
cmp qword ptr[rsp + 8], 46C4660h ; check if it's last argument (our fake argument)
jz end_args_calc ; we found our fake argument
 
mov rax, r9; ; new possible function address
cmp r8, 46C4660h ; check if it's last argument (our fake argument)
jz end_args_calc ; we found our fake argument
 
mov rax, [rcx] ; new possible function address
cmp r9, 46C4660h ; check if it's last argument (our fake argument)
jz end_args_calc ; we found our fake argument
 
;stackwalk to found our fake argument
check_for_args_end:
mov rax, [rcx + 8] ; new possible function address
cmp qword ptr[rcx], 46C4660h ; check if it's last argument (our fake argument)
jz end_args_calc ; we found our fake argument
